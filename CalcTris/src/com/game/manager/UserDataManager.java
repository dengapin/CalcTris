...
/**
 *  Manage the User Data, save and load data although the application close
...
private static UserDataManager INSTANCE;
	...
	//keep track of game score of any user
	private int mScore;
	UserDataManager() {
	...
	public synchronized void init(Context pContext) {
		if (mSettings == null) {
			...
			mScore=mSettings.getInt(SCORE, 1);
		}
	}
	...
	/*retrieve the value score of the game*/
	...
	public synchronized void setScore(int score){
		//new value score
		mScore=score;
		//put new value for the score if this changed
